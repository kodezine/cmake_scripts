...
target_sources (
  ${libName}
  PRIVATE ${canopennode-stm32_SOURCE_DIR}/CANopenNode/301/CO_Emergency.c
...
target_include_directories (
  ${libName}
  PUBLIC ${canopennode-stm32_SOURCE_DIR}/CANopenNode/301
...
target_link_libraries (${libName} ${STM32_BOARD_TYPE})
...
target_sources (${libName} PRIVATE ${CANOPEN_OBJECT_DICTIONARY_PATH}/OD.c)

target_include_directories (
  ${libName} PUBLIC ${canopennode-stm32_SOURCE_DIR}/CANopenNode ${canopennode-stm32_SOURCE_DIR}/CANopenNode_STM32
                    ${CANOPEN_OBJECT_DICTIONARY_PATH})

target_link_libraries (${libName} canopennode-stm32)
settargetcompileoptions (libName)
