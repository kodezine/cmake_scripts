...
# Sub target ------------------------------------------------------------------- Static library for generic device
# objects
...
target_include_directories (
  ${libName}
  INTERFACE $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/CMSIS/Core/Include>
            $<BUILD_INTERFACE:${CMAKE_CURRENT_SOURCE_DIR}/Device/ARM/${CMSIS_V5_ARM_DEVICE}/Include>
            $<BUILD_INTERFACE:${CMAKE_CURRENT_BINARY_DIR}> $<INSTALL_INTERFACE:${CMAKE_INSTALL_INCLUDEDIR}/${libName}>)
...
target_compile_options (
  ${libName}
  INTERFACE $<$<C_COMPILER_ID:Clang>:-Wcast-align
            -Wcast-qual
            -Wconversion
...
target_sources (
  ${GenericName}
  PRIVATE ${CMAKE_CURRENT_SOURCE_DIR}/Device/ARM/${CMSIS_V5_ARM_DEVICE}/Source/system_${CMSIS_V5_ARM_DEVICE}.c)
...
target_compile_definitions (
  ${GenericName} PUBLIC ${ARMCMFTYPE} # defines the single, double or no floating point support
)

target_link_libraries (${GenericName} ${libName})
...
# This will set the CPACK tar file as cmsis_v5-<cmsisVersion>-<cortexType>-<compiler>-<compilerVersion>.tar.gz
