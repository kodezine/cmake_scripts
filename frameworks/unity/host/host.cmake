...
function (setUnityTestProjectProperties project_name test_dir)
  ...
  execute_process (COMMAND ruby ${CMOCK_SCRIPT_PATH}/create_runner.rb ${test_dir}/host/${project_name}.c
  ...
  target_sources (
    ${project_name} PUBLIC ${TEST_INCLUDE_DIR}/host/${project_name}.c
                           ${UNITY_TEST_RUNNER_PATH}/${project_name}_runner.c ${TEST_MOCK_SOURCES} ${TEST_SOURCES})
  target_compile_definitions (${project_name} PUBLIC UNITY_MAKE_STATIC_GLOBAL)
  ...
  target_compile_options (${project_name} PRIVATE -g -O0 -Wall -Wshadow -fprofile-arcs -ftest-coverage)

  target_link_options (${project_name} PRIVATE -fprofile-arcs)

  target_link_libraries (
    ${project_name} PUBLIC cmock
                           # m #math library
  )
...
# Function to setup project library useful for making sub-directory tests
function (setUnityTestProjectStaticLibProperties project_name test_dir)
  ...
  target_sources (${projectlib_name} PUBLIC ${TEST_MOCK_SOURCES} ${TEST_SOURCES})
  target_compile_definitions (
    ${projectlib_name} PUBLIC UNITY_MAKE_STATIC_GLOBAL # Used by the compiler_attributes to expose static functions
  )

  target_include_directories (
    ${projectlib_name}
    PUBLIC $ENV{MOCK_OUT}
    PRIVATE ${canopen_SOURCE_DIR}/include
  ...
  target_link_options (${projectlib_name} PRIVATE -fprofile-arcs)

  target_link_libraries (${projectlib_name} PRIVATE mock_banshi mock_ql_os2 mock_components)
