...
# this is common for both host and target add_subdirectory(${unity_SOURCE_DIR} ${unity_BINARY_DIR})

# this links the segger rtt library
message (STATUS "Unity: Linking with Segger RTT")
target_link_libraries (unity PUBLIC # The use of SEGGER RTT has to be public, else header is not found
                                    segger_rtt)
