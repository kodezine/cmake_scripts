...
# the stm32cubexx library fetch and configuration script
# define your
# - STM32_TYPE as the type of stm32 device e.g. "f0", "f1", "f4", "l4", etc.
# - STM32_DEVICE as the exact device name e.g. "STM32F031x6", "STM32F103xB", "STM32F407xx", "STM32L476xx", etc.
# - CORTEX_TYPE as the cortex type e.g. "cm0", "cm3", "cm4", "cm7", etc.
# optionally define
# - GITHUB_BRANCH_stm32cubexx as the github tag to use with format "v1.11.5"
# - PRECOMPILED_TAG_stm32cubexx as the precompiled tag to use with format "v1.11.5"
# - PRECOMPILED_RESOURCE_stm32cubexx as the precompiled resource URL to use with SHA256 hash
# - PRE
# - cmsis_v5_CORE_INCLUDE_PATH and cmsis_v5_DEVICE_INCLUDE_PATH to use cmsis v5 from outside
# - cmsis_v6_CORE_INCLUDE_PATH and cmsis_v6_DEVICE_INCLUDE_PATH to use cmsis v6 from outside
# - STM32CubeMxConfigHeaderFile to provide a custom HAL configuration file
...
if (DEFINED PRECOMPILED_TAG_${libName})
    ...
    CPMAddPackage (
        NAME ${libName}
        GITHUB_REPOSITORY https://github.com/STMicroelectronics/${STM32CubeXX}
        GIT_TAG ${GITHUB_BRANCH_${libName}}
        DOWNLOAD_ONLY TRUE
    )
