...
# Determine if valid definitions exist for build from sources 1# overarching HAL and CMSIS driver repo fetching
# mechanism for STM32 microcontrollers
...
if (DEFINED PRECOMPILED_TAG_${libName})
  ...
  # 5# use the device family to set a cache variable for ARM Cortex Mx family here set string to represent one of the
  # above patterns
  ...
  if (NOT ${libName}_POPULATED)
    ...
    if (TARGET ${libName})
      ...
      configure_file (${CMAKE_CURRENT_LIST_DIR}/stm32cubexx.config.cmake
                      ${${libName}_SOURCE_DIR}/${libName}Config.cmake COPYONLY)
