...
#
# ============================================================================
# ATFE (Arm Toolchain for Embedded) - LLVM/Clang Toolchain Configuration
# ============================================================================
#
# This toolchain file provides support for the Arm Toolchain for Embedded
# (ATFE), which is a Clang-based compiler toolchain for bare-metal ARM
...
# ============================================================================
#
# 1. COMPILER_ROOT_PATH must be defined in your CMake cache or preset:
#    - Points to the ATFE installation directory
#    - Example: /opt/atfe/LLVMEmbeddedToolchainForArm-21.1.3
#    - Must contain bin/clang executable
#
# 2. Runtime Library Overlays:
#    - By default, auto-download is enabled (ATFE_AUTO_DOWNLOAD=ON)
#    - Overlays are downloaded from ARM GitHub releases as needed
#    - Downloaded overlays are installed in COMPILER_ROOT_PATH
#    - For offline/CI environments, pre-install overlays or disable auto-download
#
# ============================================================================
# HOW IT WORKS
# ============================================================================
...
#
# 1. Cache Variable Selection:
#    - Select runtime library via ATFE_RUNTIME_LIB (newlib/newlib-nano/picolibc)
#    - Select CRT variant via ATFE_CRT_VARIANT (default/semihost/nosys)
#    - Configure auto-download via ATFE_AUTO_DOWNLOAD (ON/OFF)
#
# 2. Early Validation:
#    - Verifies COMPILER_ROOT_PATH is set and exists
#    - Checks for clang binary existence
#    - Detects sysroot location using dual-pattern support
#
# 3. Auto-Download (if enabled):
#    - Detects clang version (major.minor)
#    - Downloads matching runtime overlay from ARM releases
#    - Verifies SHA256 checksum
#    - Extracts to COMPILER_ROOT_PATH
#    - Cleans up archive after installation
#
# 4. Config File Generation:
#    - Generates .cfg file in toolchains/common/.atfe_config/
#    - Config files are variant-specific and git-ignored
#    - Only regenerates when content changes (MD5-based)
#    - Uses relative paths for portability
#
# 5. Compiler Invocation:
#    - Clang is invoked with --config=<path-to-cfg>
#    - Config file contains all target/runtime/CRT settings
#
# ============================================================================
# CACHE VARIABLES
# ============================================================================
#
# COMPILER_ROOT_PATH (REQUIRED)
#   Path to ATFE installation directory
#   Example: /opt/atfe/LLVMEmbeddedToolchainForArm-21.1.3
#
# CORTEX_TYPE (REQUIRED)
#   Target Cortex-M variant
#   Options: cm0, cm4f, cm7
#
# ATFE_RUNTIME_LIB (Default: newlib)
#   Runtime library selection
#   Options: newlib, newlib-nano, picolibc
#
# ATFE_CRT_VARIANT (Default: default)
#   C runtime startup variant
#   Options:
#     - default:  Standard startup (-lcrt0)
#     - semihost: Semihosting support (-lcrt0-rdimon -lrdimon)
#     - nosys:    No syscalls (-lcrt0-nosys)
#
# ATFE_AUTO_DOWNLOAD (Default: ON)
#   Enable automatic download of missing runtime overlays
#   Set to OFF for offline/CI environments with pre-installed overlays
#
# ============================================================================
# EXAMPLE USAGE
# ============================================================================
...
#       "cacheVariables": {
#         "CMAKE_TOOLCHAIN_FILE": "${sourceDir}/cmake/toolchains/atfe_clang.cmake",
...
#   Solution: Define COMPILER_ROOT_PATH in your CMake cache or preset
#
# Error: "COMPILER_ROOT_PATH does not exist"
#   Solution: Verify the path points to a valid ATFE installation
#
# Error: "clang binary not found"
#   Solution: Ensure COMPILER_ROOT_PATH contains bin/clang
#
# Error: "Sysroot for 'xxx' not found"
#   Solution 1: Enable ATFE_AUTO_DOWNLOAD=ON to auto-download overlays
#   Solution 2: Manually install the overlay from ARM GitHub releases
#
# Error: "Failed to download overlay"
#   Solution: Check network connectivity or download manually from:
#   https://github.com/arm/arm-toolchain/releases
#
# Error: "Checksum verification failed"
#   Solution: Delete the downloaded file and try again, or download manually
#
# ============================================================================
...
if(NOT DEFINED CORTEX_TYPE)
    message(FATAL_ERROR 
        "ATFE Toolchain Error: CORTEX_TYPE is not defined.\n"
...
# Include cortex-specific configuration
# This will set ATFE cache variables and generate the config file
...
if(DEFINED atfe_config_file_name)
    set(FLAGS "--config=${atfe_config_file_name}" CACHE STRING "Compiler flags")
else()
