...
function (setTargetLinkOptions PROJECTNAME)
  target_link_options (
    ...
    --scatter
    ${${${PROJECTNAME}}_SCATTER_PATH}/${${${PROJECTNAME}}_SCATTER_FILE}
    --summary_stderr
    --info
    common,debug,sizes,totals,veneers,unused,summarysizes)
...
function (convertELF_BIN_HEX target)
  add_custom_command (
    ...
    POST_BUILD
    COMMAND ${TC_ELF_EXEC} --bincombined -v --output "${CMAKE_CURRENT_BINARY_DIR}/${target}.bin"
            "${CMAKE_CURRENT_BINARY_DIR}/${target}.elf"
    COMMAND ${TC_ELF_EXEC} --i32combined -v --output "${CMAKE_CURRENT_BINARY_DIR}/${target}.hex"
            "${CMAKE_CURRENT_BINARY_DIR}/${target}.elf"
