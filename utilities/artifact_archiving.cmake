...
set (
  UPSTREAM_DEP
  "fluid"
  CACHE STRING "Indicate upstream dependency")
set (
  BUILD_ENV_REF
  "dirty"
  CACHE STRING "Indicate local or ci build environment")
...
function (determine_artifact_full_name OUTPUT_VAR APP_NAME UPSTREAM_DEP BUILD_ENV_REF)
  ...
  set (
    ${OUTPUT_VAR}
    "${ARTIFACT_NAME}_${VERSION_IDENTIFICATION}"
    PARENT_SCOPE)
...
function (createNamedArtifacts target basename)
  ...
  add_custom_command (
    TARGET TARGET
    ${target}${SUFFIX} POST_BUILD
    COMMAND ${CMAKE_COMMAND} ARGS -E copy "${CMAKE_CURRENT_BINARY_DIR}/${target}.elf"
            "${CMAKE_CURRENT_BINARY_DIR}/${FULL_ARTIFACT_BASE_NAME}.elf"
    COMMAND ${CMAKE_COMMAND} ARGS -E copy "${CMAKE_CURRENT_BINARY_DIR}/${target}.hex"
            "${CMAKE_CURRENT_BINARY_DIR}/${FULL_ARTIFACT_BASE_NAME}.hex")
endfunction ()
